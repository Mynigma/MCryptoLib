...
@interface AppleEncryptionEngine_Tests : XCTestCase

@end

@implementation AppleEncryptionEngine_Tests
...
- (void)testRSADecryption
{
    ...
    AppleEncryptionEngine* engine = [[AppleEncryptionEngine alloc] initWithKeychainHelper:[UnitTestKeychainHelper new]];
