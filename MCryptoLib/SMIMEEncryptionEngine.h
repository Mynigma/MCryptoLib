...
#import "EncryptionEngineProtocol.h"




@class OpenSSLEncryptionEngine, SMIMEKeyManager, SMIMEPublicKey;

@interface SMIMEEncryptionEngine : NSObject <EncryptionEngineProtocol>

@property SMIMEKeyManager* keyManager;
