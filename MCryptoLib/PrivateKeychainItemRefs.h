...
@interface PrivateKeychainItemRefs : PublicKeychainItemRefs


/**
 * Init with SecKeyRefs of persistent or non-persistent keys
 */
...
/**
 * Init with persistent refs of persistent keys
 */
...
/**
 * Return SecKeyRefs of persistent or non-persistent keys, converting persistent refs to SecKeyRefs if necessary
 * @param forEncryption Specify YES for the decryption key, NO for the signature key
 */
- (SecKeyRef)privateSecKeyRefForEncryption:(BOOL)forEncryption;

/**
 * Return persistent refs of persistent keys, converting SecKeyRefs to persistent refs if necessary
 * This will fail for non-persistent keys
 * @param forEncryption Specify YES for the decryption key, NO for the signature key
 */
