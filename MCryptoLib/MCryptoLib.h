...
//! Project version number for MCryptoLib.
FOUNDATION_EXPORT double MCryptoLibVersionNumber;

//! Project version string for MCryptoLib.
FOUNDATION_EXPORT const unsigned char MCryptoLibVersionString[];
