...
@implementation KeychainHelper (PGP)


#if TARGET_OS_IPHONE

- (NSData*)addPublicPGPKeyWithPKCS8Data:(NSData*)data
{
    if(!data)
    {
    ...
    __block NSMutableDictionary* passDict = [KeychainHelper publicPGPKeyAdditionDict];
...
- (NSData*)addPrivatePGPKeyWithPKCS12Data:(NSData*)PKCS12KeyData
{
    //need a passphrase!!
    ...
    if(passphrase)
    {
        ...
        if(items.count>0)
        {
            ...
            NSMutableDictionary* passDict = [KeychainHelper privatePGPKeyAdditionDict];
...
- (NSData*)addPrivatePGPKeyWithPKCS8Data:(NSData*)keyData
{
