...
#import "NativeSMIMEEncryptionEngine.h"




@implementation NativeSMIMEEncryptionEngine


- (NSData*)encryptData:(NSData*)data forEmailAddresses:(NSArray*)emailAddresses error:(NSError**)error
{
    //Contrary to the documentation, the CMS stuff is not available on iOS
    
//    CMSEncoderRef encoderRef = NULL;
//    OSStatus status = CMSEncoderCreate(encoderRef);
