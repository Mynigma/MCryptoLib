...
@property (nonatomic, retain) NSSet *usedByAccounts;
@end

@interface MynigmaDevice (CoreDataGeneratedAccessors)

- (void)addUsedByAccountsObject:(EmailAddress *)value;
- (void)removeUsedByAccountsObject:(EmailAddress *)value;
- (void)addUsedByAccounts:(NSSet *)values;
- (void)removeUsedByAccounts:(NSSet *)values;
