...
@class SMIMEPublicKey, KeychainHelper, SMIMEPrivateKey;

@interface SMIMEKeyManager : NSObject
...
#pragma mark - Access by fingerprint
...
- (SMIMEPrivateKey*)addPrivateKeyWithPKCS8Data:(NSData*)PKCS1Data andX509Data:(NSData*)X509Data SHA256Fingerprint:(NSData*)fingerprint;
